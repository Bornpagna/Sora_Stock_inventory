...
//     	$this->addElement($locationID);  
    	...
    	$currencyElement->setAttribs(array('class'=>'demo-code-language','onChange'=>'getCurrency();'));
    	$currencyElement->setMultiOptions($options_cur);
    	$this->addElement($currencyElement);
    	
    	$curenrency_rate = new Zend_Form_Element_Text("cur_rate");
    	$curenrency_rate->setAttribs(array('class'=>'validate[required,custom[number]]','placeholder' => 'Enter Exchage Rate','id'=>'ex_rate','onchange'=>'netTotal();'));
    	$this->addElement($curenrency_rate);
    	...
    	$allTotalElement->setAttribs(array('readonly'=>'readonly','style'=>'text-align:right'));
...
//     	$this->addElement($isFreeTypeElement);
    	...
    	$totalAmountElement->setAttribs(array('readonly'=>'readonly','style'=>'text-align:right',//'onfocus'=>'this.value=formatCurrency(this.value)'
    	));
    	$this->addElement($totalAmountElement);
    	
    	$remainlElement = new Zend_Form_Element_Text('remain');
    	$remainlElement->setAttribs(array('readonly'=>'readonly','style'=>'text-align:right'));
    	$this->addElement($remainlElement);
    	
    	$balancelElement = new Zend_Form_Element_Text('balance');
    	$balancelElement->setAttribs(array('readonly'=>'readonly','style'=>'text-align:right'));
...
//     	$this->addElement($reqDateElement);
    	...
    	$totaTaxElement->setAttribs(array('class'=>'custom[number]','style'=>'text-align:right'));
    	$this->addElement($totaTaxElement);
    	
    	$paidElement = new Zend_Form_Element_Text('paid');
    	$paidElement->setAttribs(array('class'=>'custom[number]','Onblur'=>'doRemain();','style'=>'text-align:right'));
